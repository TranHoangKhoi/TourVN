                    ...
                    <div class="col l-10 m-12 c-12">  
                        <div class="tour__block">
                            ...
                            <div class="content__text-heading">
                                <h1 class="content__text-heading--item">Du lịch Miền Trung</h1>
                                <div class="content__text-info">
                                    <p class="content__text-info--desc">
                                        Miền Trung Việt Nam gồm Bắc Trung Bộ, Nam Trung Bộ và Tây Nguyên, tổng 19 tỉnh thành. 
                                        Miền Trung là giao điểm của sông núi hữu tình, thiên nhiên hùng vĩ, văn hóa đặc sắc, pha trộn ảnh hưởng của Hindu và Trung Hoa. 
                                        Một điểm đến lý tưởng!
                                    </p>
                                    <p class="content__text-info--return">
                                        Chúng tôi tìm thấy <strong>60</strong> tour cho quý khách.
                                    </p>
                                </div>
                            </div>
