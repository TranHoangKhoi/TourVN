                            ...
                            <div class="category-wrap">
                                ...
                                <!-- Category Button -->
                                    <div class="btn category__btn-item category__btn-left">
                                        <i class="category__btn-icon"><ion-icon name="arrow-dropleft"></ion-icon></i>
                                    </div>
    
                                    <div class="btn category__btn-item category__btn-right">
                                        <i class="category__btn-icon"><ion-icon name="arrow-dropright"></ion-icon></i>
                                    </div>
                            </div>
                                            ...
                                            <div class="col l-6 m-9 c-12">
                                                <div class="home__service-body">
                                                    ...
                                                    <div class="home__service-body--local">
                                                        <i class="home__service-body--local-icon"><ion-icon name="pin"></ion-icon></i>
